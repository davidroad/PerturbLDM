#!/usr/bin/env python3
"""Train CPA with condition-disjoint fitting, validation and test splits.

The wrapper uses at most 20 epochs, validates after every epoch, applies
patience-four early stopping and selects the validation-best checkpoint.
"""
...
BASE_SCRIPT = RUN / "scripts/train_cpa_base.py"
...
CONTRACT_PATH = RUN / "config/training_config.json"
...
def main() -> None:
    ...
    contract = {
        ...
        "intraop_threads": 40,
        "interop_threads": 16,
        "cpu_affinity_expected": "40 physical cores",
        "max_epochs": 20,
