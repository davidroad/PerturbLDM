...
This directory contains the condition-disjoint CPA training, inference and distribution-metric workflows used in manuscript Fig. 2b and Fig. 2h.
...
`../../splits/condition_assignments_seed42.csv`.
...
The selected checkpoint is used by the inference and distribution-metric scripts in `scripts/`.
...
Training and validation histories used in Supplementary Fig. S3g are distributed with the manuscript source data.
